  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#F1F5F9]">
      <div className="flex flex-1 flex-col items-center justify-center px-4 pb-10 pt-16">
        <div className="w-full max-w-sm rounded-2xl bg-white px-5 py-6 shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                type="email"
                required
                className="w-full rounded-lg border border-slate-600 bg-white px-3 py-2 text-sm outline-none ring-slate-500 placeholder:text-slate-400 focus:ring-2"
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex w-full items-center justify-center rounded-lg bg-[#0F2A44] px-3 py-2 text-sm font-semibold text-white shadow hover:bg-[#123C69] disabled:opacity-60"
            >
              {loading ? "Masuk..." : "Masuk"}
            </button>
          </form>
